...
class InstallTransitionTask(TransitionTask):
    ...
    def __init__(self, transition):
        ...
        if self.transition.deploymentLocation is None:
            ...
            if not any(loc['name'] == self.transition.deploymentLocation for loc in
                       globalConfig.locationDescriptor['locations']):
        ...
        if self.transition.resourceTypeName is None:
